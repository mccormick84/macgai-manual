...
* **저장메시지**를 관리하는 방법은 [저장메시지 관리 →](send-msg.md#undefined-6) 를 참고해주세요.
...
문자를 보낼 번호를 선택합니다. 특정 번호를 이용하여 보내려면 먼저 [발신번호등록→](send-msg.md#undefined) 이 필요합니다.

기본적으로 1) **대표SMS발송번호** 2)**로그인한 직원의 정보에 등록된 연락처** 중 하나를 선택할 수 있습니다.&#x20;

* 보내는 사람의 연락처를 추가하는 방법은 [발송용 번호 추가→](../message/add-hp.md#undefined-1) 페이지를 참고해주세요.
...
예약 날짜를 지정하여 메시지를 보냅니다. 예약 된 문자를 확인하고 취소하는 방법은 [예약 문자 취소→](../message/result.md#undefined-2) 를 참고해주세요.
