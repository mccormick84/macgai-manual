...
1. **교시 시간 설정**: 수업 시작 시간 목록을 만듭니다.  [바로가기 →](undefined.md)
2. **강의실 관리**: 수업이 진행되는 강의실 정보를 관리합니다. [바로가기 →](undefined-1.md)
3. **과목 관리**: 수업 과목을 관리합니다. [바로가기 →](undefined-2.md)
4. **수업 종류 관리**: 수업 종류와 수강 그룹을 지정합니다. [바로가기 →](undefined-3.md)
5. **수납 항목 관리**: 수납 항목을 생성, 관리합니다. [바로가기 →](undefined-4.md)
